...
export class Contract__getCollectionResultValue0Struct extends ethereum.Tuple {
  get name(): string {
...
export class Contract extends ethereum.SmartContract {
  ...
  getCollection(
    nftAddress_: Address
  ): Contract__getCollectionResultValue0Struct {
    ...
    return changetype<Contract__getCollectionResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getCollection(
    nftAddress_: Address
  ): ethereum.CallResult<Contract__getCollectionResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<Contract__getCollectionResultValue0Struct>(value[0].toTuple())
    );
  }
